...
describe('CorrelationComponent', () => {
  ...
  it('Should return r=0.9545 with the dataset Data_Test1', () => {
    spyOn(service, 'getTest1').and.returnValue(of(testData1));
    component.getData(1);
    component.calculos();
  ...
  it('Should return r=0.9333 with the dataset Data_Test2', () => {
    spyOn(service, 'getTest2').and.returnValue(of(testData2));
    component.getData(2);
    component.calculos();
  ...
  it('Should return r=0.9631 with the dataset Data_Test3', () => {
    spyOn(service, 'getTest3').and.returnValue(of(testData3));
    component.getData(3);
    component.calculos();
  ...
  it('Should return r=0.9480 with the dataset Data_Test4', () => {
    spyOn(service, 'getTest4').and.returnValue(of(testData4));
    component.getData(4);
    component.calculos();
